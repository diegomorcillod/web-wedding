      ...
      <div className="max-w-3xl mx-auto relative z-10">
        <div className="bg-white/90 shadow-xl rounded-2xl p-6 sm:p-10">
          ...
          <div className="text-center mt-20 mb-12">
            <h2 className="text-4xl sm:text-5xl font-alex-brush text-wedding-green-700 uppercase tracking-wider mb-4">
              ¿Vienes a celebrarlo con
            </h2>
            <h2 className="text-4xl sm:text-5xl font-alex-brush text-wedding-green-700 uppercase tracking-wider">
              nosotros?
            </h2>
          </div>
