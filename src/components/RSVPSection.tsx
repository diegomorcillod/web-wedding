    ...
    <section className="mt-4 text-center">
      ...
      <div className="flex items-center justify-center gap-2 sm:gap-4 mb-8">
        ...
        <div className="flex gap-1 animate-pulse">
          <span className="text-canva-pink text-lg sm:text-xl md:text-2xl">→</span>
          <span className="text-canva-pink text-lg sm:text-xl md:text-2xl animate-bounce">→</span>
        </div>
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="inline-flex items-center gap-2 bg-canva-pink hover:bg-[#B07878] text-white font-crimson font-bold text-base sm:text-xl md:text-2xl rounded-full px-6 sm:px-10 md:px-12 py-4 sm:py-5 shadow-2xl transition-all duration-300 hover:scale-110 hover:shadow-[0_20px_50px_rgba(197,138,138,0.5)] whitespace-nowrap"
        >
