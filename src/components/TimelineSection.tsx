  ...
  return (
    <section className="mt-16 max-w-2xl mx-auto">
            ...
            >
              ...
              >
                <div className={`text-${isLeft ? 'right' : 'left'} pr-${isLeft ? '4' : '0'} pl-${isLeft ? '0' : '4'}`}>
                  ...
                  <h3 className="text-xl font-dancing text-wedding-pink-600 mb-2">
                    {event.title}
                  </h3>
      ...
      <div className="text-center mt-20 mb-12">
        <h2 className="text-2xl sm:text-3xl font-script text-wedding-green-700 uppercase tracking-wider mb-4">
          ¿Vienes a celebrarlo con
        </h2>
        <h2 className="text-2xl sm:text-3xl font-script text-wedding-green-700 uppercase tracking-wider">
          nosotros?
        </h2>
      </div>
    </section>
